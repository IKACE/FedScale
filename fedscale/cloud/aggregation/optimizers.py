...
class ServerOptimizer(object):
    ...
    def __init__(self, mode, args, device):
    ...
    def update_round_gradient(self, last_model, current_model, target_model):
        ...
        if self.mode == "fed-yogi":
            # Reference: "Adaptive Federated Optimizations", Sashank J. Reddi, Zachary Charles, Manzil Zaheer, Zachary Garrett, Keith Rush, Jakub Konecný, Sanjiv Kumar, H. Brendan McMahan, ICLR 2021.
            ...
            # Reference: "Fair Resource Allocation in Federated Learning", Tian Li, Maziar Sanjabi, Ahmad Beirami, Virginia Smith, ICLR 2020.
