...
def aggr_container_init():
    ...
    logging.info("Aggregator waiting to initialize")
    while True:
        # avoid busy waiting
        time.sleep(0.1)
        try:
        ...
        if msg['type'] == 'initialize':
            logging.info("Aggregator init success!")
            new_args = msg['data']
            # print(args)
            listen_socket.close()
            return new_args
